    ...
    return {
        initJQVMAP: function () {
            ...
            if (jQuery.plot) {
                ...
                if (0 != $("#orders").size()) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $("#orders_loading").hide(), $("#orders_content").show();
                            var a = ($.plot($("#orders"), [{
                                data: t1,
                            ...
                            $("#orders").bind("plothover", function (t, i, l) {
                                if ($("#x").text(i.x.toFixed(2)), $("#y").text(i.y.toFixed(2)), l) {
                                    if (a != l.dataIndex) {
                                        ...
                                        e(l.pageX, l.pageY, l.datapoint[0], l.datapoint[1] + " الطلبيات")
                                    }
                ...
                if (0 != $("#exchanges").size()) {
                    $.ajax({
                        url: baseURL + '/exchanges-stc',
                        type: 'GET',
                        dataType: 'json',
                        success: function (data) {

                            $.each(data.items, function (i, v) {
                                t2.push([v.daily, v.count]);
                            });
                            $("#exchanges_loading").hide(), $("#exchanges_content").show();
                            var a = ($.plot($("#exchanges"), [{
                                data: t2,
                                lines: {fill: .6, lineWidth: 0},
                                color: ["#5C9BD1"]
                            }, {
                            ...
                            $("#exchanges").bind("plothover", function (t, i, l) {
                                if ($("#x").text(i.x.toFixed(2)), $("#y").text(i.y.toFixed(2)), l) {
                                    if (a != l.dataIndex) {
                                        a = l.dataIndex, $("#tooltip").remove();
                                        l.datapoint[0].toFixed(2), l.datapoint[1].toFixed(2);
                                        e(l.pageX, l.pageY, l.datapoint[0], l.datapoint[1] + " طلبات ")
                                    }
                                } else $("#tooltip").remove(), a = null
                            })
                ...
                //
                //     $.ajax({
                //         url: baseURL + '/jobs-home',
                //         type: 'GET',
                //         dataType: 'json',
                //         success: function (data) {
                //
                //             $.each(data.items, function (i, v) {
                //                 t3.push([v.daily, v.count]);
                //             });
                //             var i = null;
                //             $("#site_jobs_loading").hide(), $("#site_jobs_content").show();
                //             $.plot($("#site_jobs"), [{data: t3, lines: {fill: .2, lineWidth: 0}, color: ["#0F9D58"]}, {
                //                 data: t3,
                //                 points: {show: !0, fill: !0, radius: 4, fillColor: "#0F9D58", lineWidth: 2},
                //                 color: "#0F9D58",
                //                 shadowSize: 1
                //             }, {
                //                 data: t3,
                ...
                //                 }
                //             });
                //             $("#site_jobs").bind("plothover", function (t, a, l) {
                ...
                //                 }
                //             }), $("#site_jobs").bind("mouseleave", function () {
                //                 $("#tooltip").remove()
                //             })
                //         }
                //     });
                // }
                // if (0 != $("#site_posts").size()) {
                //
                //     $.ajax({
                ...
                //
                //             $.each(data.items, function (i, v) {
                //                 t4.push([v.daily, v.count]);
                //             });
                //             var i = null;
                //             $("#site_posts_loading").hide(), $("#site_posts_content").show();
                //
                //
                //             $.plot($("#site_posts"), [{data: t4, lines: {fill: .2, lineWidth: 0}, color: ["#F4B400"]}, {
                //                 data: t4,
                //                 points: {show: !0, fill: !0, radius: 4, fillColor: "#F4B400", lineWidth: 2},
                //                 color: "#F4B400",
                //                 shadowSize: 1
                //             }, {
                //                 data: t4,
                ...
                //                 }
                //             });
                //             $("#site_posts").bind("plothover", function (t, a, l) {
                //                 if ($("#x").text(a.x.toFixed(2)), $("#y").text(a.y.toFixed(2)), l && i != l.dataIndex) {
                //                     i = l.dataIndex, $("#tooltip").remove();
                //                     l.datapoint[0].toFixed(2), l.datapoint[1].toFixed(2);
                //                     e(l.pageX, l.pageY, l.datapoint[0], l.datapoint[1] + "M$")
                //                 }
                //             }), $("#site_posts").bind("mouseleave", function () {
                //                 $("#tooltip").remove()
                //             })
                //         }
                //     });
