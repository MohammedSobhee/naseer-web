            ...
            <div class="portlet light ">
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <textarea rows="4"  class="form-control" name="contract" placeholder="تفاصيل عقد الاتفاق">{{$setting->contract ?? ''}}
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <textarea  rows="4" class="form-control" name="terms"  id="terms"
