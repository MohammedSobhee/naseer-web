...
<div class="logo">
    <a href="javascript:;">
        <img src="{{url('/')}}/assets/layouts/layout/img/logo.png" alt=""
             style="width: 100px;margin: 3px 0 0;text-align: center;"/> </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
...
<div class="copyright"> {{\Carbon\Carbon::now()->format('Y')}} &COPY; نصير</div>
