        ...
        <div class="col-md-12">
            ...
            <div class="portlet light">
                ...
                <div class="portlet-body">
                    <div class="table-container">
                        {!! Form::open(['method'=>'POST','url'=>url(admin_constant_url().'/intros/export')]) !!}
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{url(admin_constant_url().'/intros/create')}}"
                           class="btn btn-circle btn-success add-intro-mdl">
...
@section('js')
    ...
    <script src="{{url('/')}}/assets/js/intros.js" type="text/javascript"></script>
