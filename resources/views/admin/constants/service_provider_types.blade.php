        ...
        <div class="col-md-12">
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{url(admin_constant_url().'/service-provider-types/create')}}"
                           class="btn btn-circle btn-success add-service-provider-type-mdl">
...
@section('js')
    ...
    <script src="{{url('/')}}/assets/js/service_provider_types.js" type="text/javascript"></script>
